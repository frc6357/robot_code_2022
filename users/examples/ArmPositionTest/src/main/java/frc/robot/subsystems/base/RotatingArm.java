...
public class RotatingArm 
{
     ...
     * Positions of the arm is considred relative to the arm's position.
     * 
     * @param motor CANSparkMax motor controller that controls the pivot of the arm
     * @param encoder RelativeEncoder that measures arm angle
     * @param motorRotationsToDegrees conversion factor between the motor rotations and the arm angle in degrees
     * Degrees equals motors postions times 
     * @param kP PID controller porportional gain
     * @param kI PID controller integral gain
     * @param kD PID controller derivative gain
     */
    public RotatingArm(CANSparkMax motor, 
                       RelativeEncoder encoder, 
                       double motorRotationsToDegrees, 
        ...
        this.encoder.setPositionConversionFactor(motorRotationsToDegrees);
     ...
     * 
     * @param degrees desired position of arm in degrees
     */

...
public class LoadBallVerticalCommand extends CommandBase{
    ...
    public void initialize()
    {
        ...
        this.transferSubsystem.setIntakeTransferMotorSpeed(verticalToggle? TransferConstants.BALL_VERTICAL_LOAD_SPEED : 0);
        this.transferSubsystem.setExitTransferMotor(verticalToggle? -TransferConstants.BALL_VERTICAL_LOAD_SPEED : 0);
    }

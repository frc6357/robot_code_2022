 ...
 */
public class Drive2mForwards implements AutoPaths
{
    /**
    ...
    {
        return new SequentialCommandGroup(trajectoryCreator
            .createTrajectory(segmentCreator.getTrajectory("2mForwardVerySlow PP"), false));
    }
}

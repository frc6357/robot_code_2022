 ...
 */
public class UTurnRight implements AutoPaths
{
    /**
        ...
        RamseteTrajectoryMethod trajectoryCreator)
    {
        return new SequentialCommandGroup(
            trajectoryCreator.createTrajectory(segmentCreator.getTrajectory("UTurn"), true),
            trajectoryCreator.createTrajectory(segmentCreator.getTrajectory("NinetyRight"), false));
    }
}

 ...
 */
public class Drive2mForwardBackward implements AutoPaths
{
    /**
        ...
        RamseteTrajectoryMethod trajectoryCreator)
    {
        return new SequentialCommandGroup(
            trajectoryCreator
                .createTrajectory(segmentCreator.getTrajectory("2mForwardCorner PP 2.5"), true),
            trajectoryCreator
                .createTrajectory(segmentCreator.getTrajectory("2mBackwardCorner PP 2.5"), false));
    }
}
